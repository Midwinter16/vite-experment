  ...
  <div class="create">
    <div class="create-main">
      ...
      <div class="create-main-setting">
        <el-form :model="chartsData" :label-position="labelPosition" label-width="3.5rem">
          <!-- 标题 -->
          ...
          <el-form-item label="图表类型">
            <el-select-v2 v-model="chartsData.chartType" :options="options" placeholder="Please select"></el-select-v2>
          </el-form-item>
          <!-- x轴标签 -->
          <el-form-item label="x轴标签">
            <el-input v-model.trim="chartsData.xlabel" placeholder="标签之间使用空格 / 逗号分开"></el-input>
          </el-form-item>
          <!-- y轴标签？ -->
          ...
          <el-form-item class="data-list" label="数据集">
            <div class="data-list-add">
              <div @click="addData" class="data-list-add-icon iconfont icon-jia"></div>
            </div>
            <dataCard
        ...
        <el-dialog v-model="dialogFormVisible" title="输入数据">
          <el-form :rules="tempRules" :model="tempData" label-position="top" label-width="150" ref="tempRuleFormRef">
          ...
          <template #footer>
            <span class="dialog-footer">
              ...
              <el-button type="primary" @click="createData(tempRuleFormRef)">确认</el-button>
            </span>
          </template>
        </el-dialog>
      </div>
