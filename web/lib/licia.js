...
;(function(root, factory) {
  ...
  var isSorted = (_.isSorted = (function(exports) {
    ...
    exports = function(arr) {
      var cmp = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : exports.defComparator
  ...
  var base64 = (_.base64 = (function(exports) {
    ...
    exports = {
      ...
      decode: function(str) {
        ...
        if (remain === 2) {
          tmp = (codeMap[str.charCodeAt(i)] << 2) | (codeMap[str.charCodeAt(i + 1)] >> 4)
          ret[j++] = tmp & 0xff
        } else if (remain === 1) {
          tmp =
    ...
    function numToBase64(num) {
      return code[(num >> 18) & 0x3f] + code[(num >> 12) & 0x3f] + code[(num >> 6) & 0x3f] + code[num & 0x3f]
    }
  ...
  _.binarySearch = (function(exports) {
    ...
    exports = function(arr, val) {
      var cmp = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : isSorted.defComparator
      var startIdx = 0
  ...
  _.bubbleSort = (function(exports) {
    ...
    exports = function(arr) {
      var cmp = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : isSorted.defComparator
  ...
  var isFn = (_.isFn = (function(exports) {
    ...
    exports = function(val) {
      ...
      return (
        objStr === '[object Function]' || objStr === '[object GeneratorFunction]' || objStr === '[object AsyncFunction]'
      )
    }
      ...
      while (html) {
        ...
        if (!last(stack) || !SPECIAL[last(stack)]) {
          if (startWith(html, '<!--')) {
            ...
            if (match) {
              if (handler.text) handler.text(html.substring(0, match[0].length))
          ...
          var execRes = new RegExp('</'.concat(last(stack), '[^>]*>')).exec(html)
  ...
  _.durationFormat = (function(exports) {
    ...
    exports = function(duration) {
      var mask = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'hh:mm:ss'
  ...
  _.isEqual = (function(exports) {
    ...
    function deepEq(a, b, aStack, bStack) {
      ...
      if (!areArrays) {
        ...
        if (
          aCtor !== bCtor &&
          !(isFn(aCtor) && aCtor instanceof aCtor && isFn(bCtor) && bCtor instanceof bCtor) &&
          'constructor' in a &&
          'constructor' in b
        )
          return false
  ...
  _.fileType = (function(exports) {
    ...
    var types = [
      ...
      [
        'rar',
        function(input) {
          return check(input, [0x52, 0x61, 0x72, 0x21, 0x1a, 0x7]) && (input[6] === 0x0 || input[6] === 0x1)
        },
      ],
  ...
  _.fnArgs = (function(exports) {
    ...
    exports = function(types, args) {
      ...
      if (argsLen < minLen) {
        throw Error('Expected at least '.concat(minLen, ' args but got ').concat(argsLen))
      } else if (argsLen > maxLen) {
        throw Error('Expected at most '.concat(maxLen, ' args but got ').concat(argsLen))
      }
    ...
    function validateArg(value, types, num) {
      ...
      for (var i = 0, len = types.length; i < len; i++) {
        ...
        if (t === 'any' || (t === 'object' && isObj(value)) || type(value) === t) {
          isValid = true
          break
        }
      }
      ...
      if (!isValid) {
        throw TypeError('Argument '.concat(num, ' should be type ').concat(types.join('|')))
      }
    }
  ...
  _.highlight = (function(exports) {
    ...
    exports = function(str) {
      var lang = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'js'
      ...
      each(lang, function(val, key) {
        ...
        str = str
          ...
          .replace(new RegExp('___' + key + '___', 'g'), '<span class="'.concat(val.style, '"').concat(s, '>'))
      })
      each(lang, function(val) {
        if (!val.language) return
  ...
  var Heap = (_.Heap = (function(exports) {
    ...
    exports = Class({
      initialize: function Heap() {
        var cmp = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : isSorted.defComparator
        this._cmp = cmp
        this.clear()
      },
      clear: function() {
      ...
      _heapifyDown: function(idx) {
        ...
        while (leftChildIdx(idx) < size) {
          ...
          if (rightChild < size && cmp(data[rightChildIdx], data[smallerIdx]) < 0) {
      ...
      _init: function(profile) {
        ...
        this.nodes.forEach(function(node) {
          ...
          for (var _i = curEdgeIdx; _i < maxEdgeIdx; _i += edgeFieldCount) {
            ...
            edge.init(edges.slice(_i, _i + edgeFieldCount), strings, nodeMap)
  ...
  _.Semaphore = (function(exports) {
    ...
    exports = Class({
      initialize: function Semaphore() {
        var counter = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1
  ...
  _.moment = (function(exports) {
    ...
    var Moment = Class({
      ...
      toArray: function() {
        return [this._year, this._month, this._date, this._hour, this._minute, this._second, this._millisecond]
      },
      toJSON: function() {
  ...
  _.SingleEmitter = (function(exports) {
    ...
    exports = Class(
      ...
      {
        mixin: function(obj) {
          each(['addListener', 'rmListener', 'emit', 'rmAllListeners'], function(val) {
  ...
  var Emitter = (_.Emitter = (function(exports) {
    ...
    exports = Class(
      ...
      {
        mixin: function(obj) {
          each(['on', 'off', 'once', 'emit', 'removeAllListeners'], function(val) {
            obj[val] = exports.prototype[val]
          })
  ...
  _.BloomFilter = (function(exports) {
    ...
    exports = Class({
      initialize: function() {
        ...
        var k = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 3
  ...
  _.randomId = (function(exports) {
    ...
    var defSymbols = 'ModuleSymbhasOwnPr-0123456789ABCDEFGHIJKLNQRTUVWXYZ_cfgijkpqtvxz'

    exports = function() {
      var size = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 21
      var symbols = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : defSymbols
      var id = ''
    ...
    exports = Class({
      initialize: function Tracing() {
        var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          ...
          processName = _ref$processName === void 0 ? 'Process' : _ref$processName,
          _ref$threadName = _ref.threadName,
          threadName = _ref$threadName === void 0 ? 'Thread' : _ref$threadName
      ...
      instant: function(cat, name) {
        var scope = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 't'
  ...
  _.css = (function(exports) {
    ...
    var Parser = Class({
      ...
      rules: function() {
        ...
        while (this.input.length && this.input[0] !== '}' && (rule = this.atRule() || this.rule())) {
          rules.push(rule)
          this.whitespace()
        }
  ...
  _.normalizePhone = (function(exports) {
    ...
    exports = function(phone, options) {
      ...
      var countryCode = options.countryCode,
        ...
        trunkPrefix = _options$trunkPrefix === void 0 ? false : _options$trunkPrefix
  ...
  var table = (_.table = (function(exports) {
    ...
    function padData(rows, options) {
      ...
      return loopData(rows, function(data, row, column) {
        ...
        return repeat(' ', paddingLeft) + data + repeat(' ', width - strWidth(data) - paddingRight)
      })
    }
        ...
        run: function() {
          ...
          var pendingPromise = new Promise(function(resolve, reject) {
            var runSample = function() {
              var initCount = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1
              delay(function() {
                _this
                  ...
                  .then(function(_ref) {
                    ...
                    if (perfNow() - _this._timeStamp < options.maxTime || sample.length < options.minSamples) {
                      runSample(count)
                    } else {
        ...
        _calcResult: function() {
          ...
          var result = {
            ...
            toString: function() {
              ...
              return ''
                .concat(name, ' x ')
                .concat(formatNumber(hz.toFixed(hz < 100 ? 2 : 0)), ' ops/sec \xB1')
            ...
            results.toString = function() {
              var data = map(results, function(_ref2, idx) {
                ...
                columns.push(
                  ...
                  ''.concat(size, ' run').concat(size === 1 ? '' : 's')
                )
                return columns
              })
              data.unshift(['index', 'name', 'ops/sec', 'rme', 'sampled'])
              return table(data)
            }
  ...
  _.stringifyAll = (function(exports) {
      ...
      if (t === 'String') {
        ...
        if (!visitedObj) {
          ...
          if (enumerableKeys.length) {
            parts.push(iterateObj('enumerable', enumerableKeys, self || obj, options))
          }
          ...
          if (unenumerable) {
            ...
            if (unenumerableKeys.length) {
              parts.push(iterateObj('unenumerable', unenumerableKeys, self || obj, options))
            }
          }
          ...
          if (symbol) {
            ...
            if (symbolKeys.length) {
              parts.push(iterateObj('symbol', symbolKeys, self || obj, options))
            }
          }
    ...
    function iterateObj(name, keys, obj, options) {
      ...
      each(keys, function(key) {
        ...
        if (hasGetter) {
          parts.push(''.concat(wrapKey('get ' + toStr(key)), ':').concat(exports(descriptor.get, options)))
        }

        if (hasSetter) {
          parts.push(''.concat(wrapKey('set ' + toStr(key)), ':').concat(exports(descriptor.set, options)))
        }
      })
  ...
  _.stripIndent = (function(exports) {
    ...
    exports = function(literals) {
      ...
      for (
        var _len = arguments.length, placeholders = new Array(_len > 1 ? _len - 1 : 0), _key = 1;
        _key < _len;
        _key++
      ) {
      ...
      return function() {
        ...
        return new Promise(function(resolve, reject) {
          ...
          function next(ret) {
            ...
            return onRejected(new TypeError('You may only yield a promise, '.concat(toStr(ret.value), ' is passed')))
          }
      ...
      var chunks = reduce(
        ...
        function(chunks, word) {
          ...
          if (word.length > width) {
            chunks = concat(chunks, word.match(new RegExp('.{1,'.concat(width, '}'), 'g')))
          } else {
            chunks.push(word)
          }
